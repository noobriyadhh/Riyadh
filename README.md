...
<!-- Animated name: first try GIF (recommended). If GIF missing, show static SVG as fallback. -->
<p align="center">
  <!-- GIF (recommended: upload assets/riyadh-name.gif) -->
  <img src="https://raw.githubusercontent.com/YourUsername/YourRepo/main/assets/riyadh-name.gif"
       alt="Riyadh Usual" width="600"/>

  <!-- fallback (optional): static svg if gif not available -->
  <!-- <img src="https://raw.githubusercontent.com/YourUsername/YourRepo/main/assets/riyadh-name.svg" alt="Riyadh Usual" width="600"/> -->
</p>
